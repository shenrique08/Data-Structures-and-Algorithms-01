...
int main()
{
    ...
    printf("\n---------- Lista 1 apos a [primeira] INSERCAO no INICIO ---------- \n");
    ...
    inserir_inicio(lista_circular, dados_aluno);
    printf("\n---------- Lista 1 apos a [segunda] INSERCAO no INICIO ---------- \n");
    imprime_lista(lista_circular);
    ...
    printf("\n---------- Lista 1 apos a [primeira] INSERCAO no FINAL ---------- \n");
    imprime_lista(lista_circular);
    ...
    inserir_fim(lista_circular, dados_aluno);
    printf("\n---------- Lista 1 apos a [segunda] INSERCAO no FINAL ---------- \n");
    imprime_lista(lista_circular);
    ...
    imprime_lista(lista_circular);
    */
    printf("[TAMANHO DA LISTA 1]: [%d] Alunos\n\n", tamanho_lista(lista_circular));
   ...
   imprime_lista(lista_circular);
    ...
    Lista_Circular *lista2 = cria_lista();
    ...
    printf("\n========================================= LISTA 2 =============================================\n\n");
    // inserindo no final 1 
    dados_aluno2.matricula = 925347;
    strcpy(dados_aluno2.nome, "Gibiao");
    dados_aluno2.nota = 56.5;

    inserir_fim(lista2, dados_aluno2);
    printf("\n---------- Lista 2 apos a [primeira] INSERCAO no FINAL ---------- \n");
    imprime_lista(lista2);

    // inserindo no final 2
    dados_aluno2.matricula = 978615;
    strcpy(dados_aluno2.nome, "Geovaldo");
    dados_aluno2.nota = 98.8;

    inserir_fim(lista2, dados_aluno2);
    printf("\n---------- Lista 2 apos a [segunda] INSERCAO no FINAL ---------- \n");
    imprime_lista(lista2);

    // inserindo no final 3
    dados_aluno2.matricula = 234894;
    strcpy(dados_aluno2.nome, "Carceres");
    dados_aluno2.nota = 98.8;

    inserir_fim(lista2, dados_aluno2);
    printf("\n---------- Lista 2 apos a [terceira] INSERCAO no FINAL ---------- \n");
    imprime_lista(lista2);
    printf("[TAMANHO DA LISTA 2]: [%d] Alunos\n\n", tamanho_lista(lista2));


    Lista_Circular *lista3 = intersection(lista_circular, lista2);
    printf("\n============================ LISTA COM A INTERSECCAO DA LISTA 1 COM A LISTA 2 =============================== \n\n");
    ...
    */
    ...
    printf("\n\nQuantidade de ocorrencias do aluno Carceres: [%d]\n\n", conta_ocorrencias(lista_circular, dados_aluno));
    inserir_fim2(lista_circular, dados_aluno);
